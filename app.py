...
#                 weighted_gini = (len(y[left_idx])/n_samples * gini_left +
...
#     print("Pickle not found. Training model...")
...
#     else:
#         result_text = "Low risk of cardiovascular disease. Keep healthy habits!"

#     # Render the same form page with prediction
#     return render_template("form.html", prediction_text=result_text)
